 ...
 */
package co.edu.sena.ExampleJDBC.ExampleDB.View;
    ...
    public void fillTable()
    {
        try {
            ...
            for (Record r : records) {
                ...
                rows[4] = r.getEmployee_id().getFullname();
                rows[5] = r.getKey_id().getName();
                rows[6] = r.getStatus();
    ...
    private void jTableRecordsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableRecordsMouseClicked
        ...
        if(rowSelected != -1)
        {
            ...
            try {
                ...
                datePickerDate.setDate(LocalDate.parse(r.getDate_record()));
                timePickerEndTime.setText(r.getEnd_time()!= null ? r.getEnd_time(): null);
                timePickerStartTime.setText(r.getStart_time());
                jComboBoxEmployee.getModel().setSelectedItem(r.getEmployee_id());
                jComboBoxKey.getModel().setSelectedItem(r.getKey_id());
